...
import { FullUserItem, GroupItem, GroupMemberItem, PublicUserItem, RtcInvite } from "../../../utils/open_im_sdk/types";
import { customType, SessionType } from "../../../constants/messageContentType";
...
const RtcModal: FC<RtcModalProps> = ({ visible, isVideo, isSingle, isCalled, invitation, myClose }) => {
  ...
  const { connect, room, participants, isConnecting } = useRoom();
  ...
  const sendInvite = (config: RtcInvite) => {
    if (config.sessionType === SessionType.SINGLECVE) {
